...
- **Storage:** JSON files in `data/conversations/` and `data/templates/`
- **Package Management:** uv for Python, npm for JavaScript

## Documentation

- `PROMPT_TEMPLATES.md` - Guide to using the prompt template library
- `TOOLS_DOCUMENTATION.md` - Information about tool calling capabilities
- `QUICKSTART_TOOLS.md` - Quick start guide for tools
